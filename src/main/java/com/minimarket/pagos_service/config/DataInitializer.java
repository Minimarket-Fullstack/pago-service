...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Pago pago1 = new Pago(null,
                ...
                15990.0,MetodoPago.TARJETA,EstadoPago.PAGADO,"PED-847291",true);

        Pago pago2 = new Pago(null,
                2L,2L,
                LocalDateTime.now().minusHours(1),
                24990.0,MetodoPago.TRANSFERENCIA,EstadoPago.PENDIENTE,"PED-563874",true);

        Pago pago3 = new Pago(null,
                3L,3L,LocalDateTime.now().minusDays(1),
                8990.0,MetodoPago.EFECTIVO,EstadoPago.PAGADO,
                "PED-918245",true);

        Pago pago4 = new Pago(null,
                4L,4L,LocalDateTime.now().minusMinutes(45),45990.0,
                MetodoPago.TARJETA,EstadoPago.RECHAZADO,"PED-374650",true);
...
//        pagoRepository.save(pago5);
        pagoRepository.saveAll(List.of(pago1, pago2, pago3,pago4,pago5));
